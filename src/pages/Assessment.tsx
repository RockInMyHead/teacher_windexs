  ...
  "questions": [
    {
      ...
      1: `Ты - академический преподаватель английского языка для русскоязычных студентов. Создай 5 вопросов по английской грамматике на РУССКОМ языке.
...
1. "Какое предложение правильно использует Present Simple?"
   - "Она идет в школу каждый день."
   - "Она ходит в школу каждый день."
   - "Она пошла в школу каждый день."
   - "Она будет идти в школу каждый день."

2. "Как переводится модальный глагол 'must' в значении обязанности?"
   - "Мочь"
   - "Должен"
   - "Можно"
   - "Нужно"
  ...
  "questions": [
    {
      ...
      2: `Ты - академический преподаватель арабского языка для русскоязычных студентов. Создай 5 вопросов по арабскому языку на РУССКОМ языке.
  ...
  "questions": [
    {
      ...
      "options": ["Вариант A на русском", "Вариант B на русском", "Вариант C на русском", "Вариант D на русском"],
      "correctAnswer": 0,
      "explanation": "Объяснение на русском языке с примерами арабской грамматики",
      "difficulty": "easy|medium|hard"
    }
  ]
}`,

      3: `Ты - академический преподаватель китайского языка для русскоязычных студентов. Создай 5 вопросов по китайскому языку на РУССКОМ языке.
  ...
  "questions": [
    {
      ...
      "options": ["Вариант A на русском", "Вариант B на русском", "Вариант C на русском", "Вариант D на русском"],
      "correctAnswer": 0,
      "explanation": "Объяснение на русском языке с примерами китайской грамматики",
      "difficulty": "easy|medium|hard"
    }
  ]
}`,
...
Формат ответа (ТОЛЬКО JSON):
{
  ...
  const getUserPrompt = (courseId: number): string => {
    const userPrompts: { [key: number]: string } = {
      ...
      1: 'Создай 5 вопросов по английской грамматике для русскоязычных студентов. ВСЕ вопросы и ответы должны быть на русском языке.',
      2: 'Создай 5 вопросов по арабскому языку для русскоязычных студентов. ВСЕ вопросы и ответы должны быть на русском языке.',
      3: 'Создай 5 вопросов по китайскому языку для русскоязычных студентов. ВСЕ вопросы и ответы должны быть на русском языке.',
