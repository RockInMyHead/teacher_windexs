          ...
          <div className="flex items-center justify-between">
            ...
            <div className="flex items-center gap-4">
              <div className="text-right">
                <p className="text-sm font-medium">Добро пожаловать, {user?.name}!</p>
                {user?.knowledgeLevel && (
      ...
      <main className="container mx-auto px-4 py-8">
        ...
        <div className="grid md:grid-cols-4 gap-6 mb-8">
          <Card>
            ...
            <CardContent>
              <div className="text-2xl font-bold">{user?.stats?.activeCourses || 0}</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Завершено модулей</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{user?.stats?.completedModules || 0}</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
            ...
            <CardContent>
              <div className="text-2xl font-bold">{user?.stats?.averageProgress || 0}%</div>
            </CardContent>
          </Card>
          <Card>
            <CardHeader className="pb-2">
              <CardTitle className="text-sm font-medium text-muted-foreground">Достижения</CardTitle>
            </CardHeader>
            <CardContent>
              <div className="text-2xl font-bold">{user?.stats?.achievements || 0}</div>
            </CardContent>
          </Card>
        </div>
