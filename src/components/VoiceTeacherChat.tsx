...
## Цели урока
[Опиши 3-4 конкретные цели урока]

## План урока
[Краткий план из 5 основных этапов]
...
## Входная диагностика
[Вопросы для проверки знаний в формате нумерованного списка]

ВАЖНО: Все цифры, числа, формулы и математические выражения ПИШИ СЛОВАМИ, а не цифрами. Например, вместо "2+2=4" пиши "два плюс два равно четыре". Вместо "5 класс" пиши "пятый класс".

Верни ответ в формате JSON массива строк, где каждый элемент - это отдельный блок урока с Markdown форматированием.`;
...
2. ИСПОЛЬЗУЙ MARKDOWN ФОРМАТИРОВАНИЕ для лучшей читаемости
